...
type Querier interface {
	...
	ListContractParties(ctx context.Context, contractID string) ([]Party, error)
	ListContractSignatures(ctx context.Context, contractID string) ([]Signature, error)
	ContractQuery(ctx context.Context, arg ContractQueryParams) ([]Signature, error)
